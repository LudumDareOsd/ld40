...
export default class {
    ...
    loadMap(levelNumber, powerUpCollisionGroup, opponentCollisionGroup, playerCollisionGroup) {
        ...
        if (powerUpCollisionGroup && opponentCollisionGroup) {
            ...
            this.state.createOpponents(this.path, powerUpCollisionGroup, opponentCollisionGroup, playerCollisionGroup, this.startPositions[4].x, this.startPositions[4].y, this);
            this.state.createOpponents(this.path, powerUpCollisionGroup, opponentCollisionGroup, playerCollisionGroup, this.startPositions[5].x, this.startPositions[5].y, this);
        }
